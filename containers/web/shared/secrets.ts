...
export const SECRET_FIELDS: SecretField[] = [
  ...
  { key: "BINANCE_API_KEY", group: "broker", label: "Binance API Key", secret: true },
  { key: "BINANCE_API_SECRET", group: "broker", label: "Binance API Secret", secret: true },
  { key: "BINANCE_ENV", group: "broker", label: "Binance Env", hint: "live (기본) 또는 testnet" },
