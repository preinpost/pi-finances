...
<!--
  Source: https://github.com/snflkd/fluent-korean (MIT)
  Variant: plugins/fluent-korean/output-styles/fluent-korean-not-coding.md
...
- 종목 티커(RKLB, NVDA), 숫자, 통화 코드(USD, KRW)처럼 관용적으로 원어를 쓰는 고유 명사와 단위는 원어를 유지합니다.
